...
public class ItemYellowjacketHelmet extends ItemAntManArmorHelmet {
	
	public ItemYellowjacketHelmet(String name, int i, ShrinkerTypes type) {
		super(name, i, type);
	}
	...
	public ModelBiped getArmorModel(EntityLivingBase entityLiving, ItemStack stack, int armorSlot) {
		...
		if (stack != null) {
			armorModel = new ModelYellowjacketHelmet(0.5F);
			if (armorModel != null) {
