...
public class MessageFlyKeys implements IMessage, IMessageHandler<MessageFlyKeys, IMessage> {
	...
	public MessageFlyKeys() {
	}

	public MessageFlyKeys(boolean flyState, boolean descendState,
			boolean forwardState, boolean backwardState, boolean leftState,
			boolean rightState) {
    ...
    @Override
    public IMessage onMessage(MessageFlyKeys msg, MessageContext ctx) {
