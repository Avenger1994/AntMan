...
public class RecipeHandlerPymWorkbench extends TemplateRecipeHandler
{
    ...
    public void loadTransferRects() {
        transferRects.add(new RecipeTransferRect(new Rectangle(84, 23, 24, 18), "pymWorkbench"));
    }

    @Override
    public Class<? extends GuiContainer> getGuiClass() {
        return GuiPymWorkbench.class;
    }

	@Override
	public String getRecipeName() {
		return StatCollector.translateToLocal("tile.pymWorkbench.name");
	}

    @Override
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId.equals("pymWorkbench") && getClass() == RecipeHandlerPymWorkbench.class) {
            for (IRecipe irecipe : (List<IRecipe>) PymWorkbenchCraftingManager.recipes) {
    ...
    public String getGuiTexture() {
        return AntMan.ASSETDIR + "textures/gui/pymWorkbenchNEI.png";
    }
